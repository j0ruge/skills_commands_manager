...
| Skill | Description |
|-------|-------------|
| `/cicd` | Troubleshoots and configures CI/CD pipelines — 30+ scenarios, 34+ lessons learned (incl. dedicated `self-hosted-runner-docker.md` reference for `myoung34/github-runner` setups, e `cd-pipeline-pitfalls.md` cobrindo 4 classes de cutover-prod bugs incluindo upstream pool poisoning por `compose run` orphans) |
