...
```bash
/plugin install codereview    # or: ansible-docker-backup-restore, cicd, cors, criar-prd, criar-task, criar-techspec, ddd, deploy, dev-script, dotnet-wpf, executar-task, kaizen-software, pdf-generation, release, retrofit-skill, statusline, ticket, unlovable, whisper-preprocess, wsl-windows-onboarding, zitadel-idp
```
