...
[![Plugins](https://img.shields.io/badge/plugins-14-blue?style=flat-square)](#available-plugins)
...
```bash
/plugin install codereview    # or: cicd, ddd, deploy, dev-script, dotnet-wpf, pdf-generation, release, retrofit-skill, statusline, ticket, whisper-preprocess, wsl-windows-onboarding, zitadel-idp
```
