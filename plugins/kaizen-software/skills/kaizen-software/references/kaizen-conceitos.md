...
- **Poka-yoke** — "à prova de erro": desenhar o processo para o erro ser impossível ou óbvio. No software: tipos que não compilam com valor inválido, validação Zod na borda, lint que barra o padrão proibido.
